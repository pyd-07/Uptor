    ...
    return (
        <>
            ...
            <div className={"pt-6 overflow-y-auto no-scrollbar px-2 space-y-6 pb-8"}>
                <section className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 p-6 sm:p-8">
                    <div className="absolute -top-20 -right-16 size-64 rounded-full bg-orange-500/10 blur-3xl" />
                    <div className="absolute -bottom-24 -left-10 size-52 rounded-full bg-cyan-500/10 blur-3xl" />
                ...
                <section className="glass-card rounded-3xl border border-white/10 p-6">
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                        {includedFeatures.map((feature) => (
                            <div key={feature} className="flex items-center gap-2 rounded-xl border border-white/10 bg-slate-900/60 px-3 py-2 text-sm text-slate-200">
